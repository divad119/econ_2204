...
\tightlist
\item
  \{r\} \#\textbar{} echo: false \#\textbar{} fig-cap: ``Simple Ploy of
  X Versus Y'' \#\textbar{} label: fig-scatterplot x \textless- c(1:10)
  y \textless- 2*x+ 5 plot (x, y) As shown in Figure
  \textbf{?@fig-scatterplot}, Y increases linearly with X.
\end{enumerate}
...
``Dan'') grade = c(82, 75, 91, 68) )

students

average\_grade \textless- mean(students\$grade) average\_grade
